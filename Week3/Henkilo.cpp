...
Henkilo::Henkilo(string aNimi, int aIka) : nimi(aNimi), ika(aIka), kotiOsoite()
{
}

Henkilo::Henkilo(string aNimi, int aIka, Osoite aOsoite) : nimi(aNimi), ika(aIka), kotiOsoite(aOsoite)
{
}
