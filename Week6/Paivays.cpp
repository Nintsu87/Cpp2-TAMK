...
Paivays::Paivays(const Paivays& aPaivays)
	: paiva(aPaivays.paiva), kuukausi(aPaivays.kuukausi), vuosi(aPaivays.vuosi)
{
	cout << "*Paivays kopsattu* ";
}
